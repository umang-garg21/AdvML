...
def adversarial_train(model, device, train_loader, val_loader, eps, alpha, num_steps, epochs, loss_type, num_classes):
    ...
    ckpt_pth = "/home/teamteam/AdvML/HW2/Fast_adv_trained_model_200epochs_new.pt"
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('Accuracies vs epoch_FAST_AT.png')

    np.savetxt("accuracy_clean_lst_Fast_AT.csv", 
           accuracy_clean_lst,
           delimiter =", ", 
           fmt ='%f')

    np.savetxt("accuracy_adv_lst_Fast_AT.csv", 
           accuracy_adv_lst,
           delimiter =", ", 
           fmt ='%f')
...
def main():
    ...
    ############### TEST MODE ################
    PATH = "/home/teamteam/AdvML/HW2/Fast_adv_trained_model_200epochs_new.pt"
